...
define config.name = _("Traces of blood")
...
define build.name = "Tracesofblood"
...
define config.main_menu_music = "sounds/musicamenuprinc.mp3"
...
define config.save_directory = "Tracesofblood-1540434830"
